package br.com.pedrohsantos.architectureexemple;
...
import br.com.pedrohsantos.architectureexemple.activity.AddEditNoteActivity;
import br.com.pedrohsantos.architectureexemple.adapter.NoteAdapter;
import br.com.pedrohsantos.architectureexemple.room.entity.NoteEntity;
import br.com.pedrohsantos.architectureexemple.viewModel.NoteViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(requestCode == ADD_NOTE_REQUEST && resultCode == RESULT_OK){
            ...
            if(id == -1){
                Toast.makeText(this, "Note cant't be updated", Toast.LENGTH_SHORT).show();
                return;
            }
